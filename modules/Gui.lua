...
local MenuBtn = Instance.new("TextButton", Screen); MenuBtn.Size = UDim2.new(0, 80, 0, 30); MenuBtn.Position = UDim2.new(0.5, -40, 0, 10); MenuBtn.BackgroundColor3 = Color3.fromRGB(20, 20, 20); MenuBtn.Text = "MENU"; MenuBtn.TextColor3 = _G.SETTINGS.AccentColor; MenuBtn.Font = Enum.Font.GothamBold; Instance.new("UICorner", MenuBtn)
